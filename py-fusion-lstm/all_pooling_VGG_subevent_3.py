...
def main():
    ...
    for i in range(video_num):
        ...
        for j in range(20):
            ...
            for z in range(512):
                ...
                #fusion2 = np.sum(channel_raw + channel_flow)+np.average(channel_optical)+np.max(channel_optical) #85%
    ...
    #np.save('features/finetunned_ucf101_vgg_jpl_all_fusion_subevent_20.npy', final_feature)


    np.save('features/finetunned_ucf101_vgg_utk_all_fusion_subevent_20.npy',
            final_feature)  # original model + sub-event(3frames fft)
