...
training_steps=1000
#training_steps=1000  #JPL-94.35%
# reference of iccv2017  == epoch #900
batch_size = 42
display_step = 10

# Network Parameters
#num_hidden = 500 # hidden layer num of features #JPL-94.35%
num_hidden = 500
...
def RNN(x, weights, biases):
    ...
    #lstm_cell = rnn.GRUCell(num_hidden,  reuse=tf.AUTO_REUSE)
...
for iter in range(test_num):
    ...
    #fusioned_features = np.load('features/finetunned_ucf101_vgg_jpl_fusion_test_xx.npy')
    fusioned_features = np.load('features/finetunned_ucf101_vgg_jpl_all_fusion_svd_9_19.npy')
    #fusioned_features = np.load('features/finetunned_ucf101_vgg_jpl_all_fusion_svd_17.npy')
    ...
    with tf.Session() as sess:
        ...
        """
        test_file = "index_jpl/testlist02.txt"
